...
def update_minimap(x, y, actor="robot", direction="N", minimap=255*np.ones((600, 500, 3), dtype="uint8")):
    interval = (470-30)//4
...
if __name__ == "__main__":
    minimap = update_minimap(3, 2, "robot", "W")
    minimap = update_minimap(2, 4, "villain")
    minimap = update_minimap(0, 1, "obstacle")
    display_image(minimap)
